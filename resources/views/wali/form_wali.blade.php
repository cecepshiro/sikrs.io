...
<div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Tambah Data Wali</li>
      </ol>
      <div class="card mb-3">
      <div class="card-header">Form Wali</div>
      <div class="card-body">
      <form method="POST" action="{{ route('wali.store') }}" enctype="multipart/form-data">
      {{ csrf_field() }}
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-12">
                <label for="exampleInputName">Kode Wali</label>
                <input class="form-control" id="exampleInputName" type="text" name="kode_wali" aria-describedby="nameHelp" placeholder="Kode Wali" required>
              </div>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-12">
                ...
                <select class="itemName2 form-control" name="nim" required></select>  
              </div>
            </div>
          </div>
          <div class="row">
