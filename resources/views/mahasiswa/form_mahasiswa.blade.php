      ...
      {{ csrf_field() }}
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-12">
                ...
                <input class="form-control" id="exampleInputName" type="text" name="nama" aria-describedby="nameHelp" placeholder="Nama" required>
              </div>
            </div>
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">NIM</label>
            <input class="form-control" id="exampleInputName" type="text" maxlength="10" name="nim" aria-describedby="nameHelp" placeholder="NID" required>
          </div>
          <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-1 offset-md-9">
              <a href="{{ route('mahasiswa.index') }}" class="btn btn-danger btn-md">Batal</a>
            </div>
